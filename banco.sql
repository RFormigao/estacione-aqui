...
insert  into `alocacao`(`id_alocacao`,`vaga`,`hora_entrada`,`dataa`,`id_veiculo`,`status`) values (57,1,NULL,NULL,NULL,'alocar'),(58,2,NULL,NULL,NULL,'alocar'),(59,3,NULL,NULL,NULL,'alocar'),(60,4,NULL,NULL,NULL,'alocar'),(61,5,NULL,NULL,NULL,'alocar'),(62,6,NULL,NULL,NULL,'alocar'),(63,7,NULL,NULL,NULL,'alocar'),(64,8,NULL,NULL,NULL,'alocar'),(65,9,NULL,NULL,NULL,'alocar'),(66,10,NULL,NULL,NULL,'alocar'),(67,11,NULL,NULL,NULL,'alocar'),(68,12,NULL,NULL,NULL,'alocar'),(69,13,NULL,NULL,NULL,'alocar'),(70,14,NULL,NULL,NULL,'alocar'),(71,15,NULL,NULL,NULL,'alocar'),(72,16,NULL,NULL,NULL,'alocar'),(73,17,NULL,NULL,NULL,'alocar'),(74,18,NULL,NULL,NULL,'alocar'),(75,19,NULL,NULL,NULL,'alocar'),(76,20,NULL,NULL,NULL,'alocar');
...
insert  into `cliente`(`id_cliente`,`nome`,`cpf`,`telefone`,`status`) values (38,'Vanessa Formigão','720.137.479-10','(14) 99747-2014','A'),(39,'Jonathan Gomes','173.200.654-25','(14) 99743-2147','A');
...
insert  into `periodo`(`id_periodo`,`periodo`,`valor`,`status`) values (1,'00:10:00','2.00','A'),(2,'00:15:00','3.00','A'),(3,'00:20:00','4.00','A'),(4,'00:25:00','5.00','A'),(5,'00:30:00','6.00','A'),(6,'00:35:00','7.00','A'),(7,'00:40:00','8.00','A'),(8,'00:45:00','9.00','A');
...
insert  into `pessoa`(`id_pessoa`,`nome`,`cpf`,`cel`,`tel`,`logradouro`,`bairro`,`cep`,`cidade`,`uf`,`usuario`,`senha`,`id_tipo`,`status`) values (17,'Robson Formigão','460.706.578-10','(14) 99742-5930','(14) 3624-7391','Deolindo de Oliveira e Souza 201','Jardim Sanzovo','17204-670','Jau','SP','admin','admin',1,'A'),(18,'Jaqueline Pachoal','674.472.247-17','(14) 99743-4791','(14) 3626-3263','Abolição 70','Centro','17200-001','Mineiros do Tiete','SP','func','func',2,'A');
...
insert  into `veiculo`(`id_veiculo`,`placa`,`modelo`,`id_cliente`,`status`) values (14,'FND-1226','Palio',38,'A'),(15,'FND-2020','Fiesta',39,'A');
...
begin
	if (p = "" || p is null)then
		select "Modelo de placa Inválido." as msg; 
	else
		if (p not in (select placa from veiculo where placa = p AND status = "A")) then
			select "Está placa não está cadastrada." as msg;
		else
			if (p in (SELECT ve.placa FROM alocacao a INNER JOIN veiculo ve ON (a.id_veiculo = ve.id_veiculo) WHERE ve.placa = p)) then
				select "Esse veiculo já está alocado." as msg;
			else
